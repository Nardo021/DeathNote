...
import com.yaazyy.deathnote.forge1201.audit.ForgeFileAuditSink;
import com.yaazyy.deathnote.forge1201.item.DeathNoteItem;
import com.yaazyy.deathnote.forge1201.item.Forge1201ItemBridge;
import com.yaazyy.deathnote.forge1201.network.DeathNoteNetwork;

import net.minecraftforge.fml.loading.FMLPaths;

/**
 * Holds wired Death Note services for the Forge 1.20.1 mod.
 */
public final class ModContext {
    ...
    private Forge1201ItemBridge itemBridge;
    private Forge1201DeathNotePlatform platform;
    ...
    private void wire() {
        ...
        this.itemBridge = new Forge1201ItemBridge(config, signatures, DeathNoteItem.DEATH_NOTE.get());
        this.platform = new Forge1201DeathNotePlatform(config);
    ...
    public Forge1201ItemBridge itemBridge() {
        return itemBridge;
    }

    public Forge1201DeathNotePlatform platform() {
        return platform;
    }
