...
import com.yaazyy.deathnote.forge189.audit.ForgeFileAuditSink;
import com.yaazyy.deathnote.forge189.item.Forge189ItemBridge;

/**
 * Holds wired Death Note services for the Forge 1.8.9 mod.
 */
public final class ModContext {
    ...
    private Forge189ItemBridge itemBridge;
    private Forge189DeathNotePlatform platform;
    ...
    public static void init(File forgeConfigDir, Logger logger) {
        File dir = new File(forgeConfigDir, "deathnote");
    ...
    private void wire() {
        ...
        this.itemBridge = new Forge189ItemBridge(config, signatures);
        this.platform = new Forge189DeathNotePlatform(config);
    ...
    public Forge189ItemBridge itemBridge() {
        return itemBridge;
    }

    public Forge189DeathNotePlatform platform() {
        return platform;
    }
