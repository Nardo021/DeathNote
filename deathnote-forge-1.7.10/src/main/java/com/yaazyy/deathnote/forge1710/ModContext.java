...
import com.yaazyy.deathnote.forge1710.audit.ForgeFileAuditSink;
import com.yaazyy.deathnote.forge1710.item.Forge1710ItemBridge;

/**
 * Holds wired Death Note services for the Forge 1.7.10 mod.
 */
public final class ModContext {
    ...
    private Forge1710ItemBridge itemBridge;
    private Forge1710DeathNotePlatform platform;
    ...
    public static void init(File modConfigDir, Logger logger) {
        File dir = new File(modConfigDir, "deathnote");
    ...
    private void ensureDefaults() {
        if (!configDir.exists() && !configDir.mkdirs()) {
            logger.warning("Could not create config directory: " + configDir);
        }
    ...
    private void wire() {
        ...
        this.itemBridge = new Forge1710ItemBridge(config, signatures, DeathNoteMod.instance.deathNoteItem);
        this.platform = new Forge1710DeathNotePlatform(config);
    ...
    public Forge1710ItemBridge itemBridge() {
        return itemBridge;
    }

    public Forge1710DeathNotePlatform platform() {
        return platform;
    }
